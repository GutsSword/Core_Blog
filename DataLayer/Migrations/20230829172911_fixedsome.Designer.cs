...
namespace DataLayer.Migrations
{
    ...
    [Migration("20230829172911_fixedsome")]
    partial class fixedsome
    {
            ...
            modelBuilder.Entity("EntityLayer.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e91a6f5d-c276-468e-8981-c1eab1b47c64"),
                            CategoryId = new Guid("dd841da1-ec1e-443b-ad5a-898c19ee804c"),
                            Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 29, 20, 29, 11, 152, DateTimeKind.Local).AddTicks(1227),
            ...
            modelBuilder.Entity("EntityLayer.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 29, 20, 29, 11, 152, DateTimeKind.Local).AddTicks(1457),
                            IsDeleted = false,
                            Name = "Kategori1"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 29, 20, 29, 11, 152, DateTimeKind.Local).AddTicks(1513),
                            IsDeleted = false,
                            Name = "Kategori2"
                        });
                });
            ...
            modelBuilder.Entity("EntityLayer.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 29, 20, 29, 11, 152, DateTimeKind.Local).AddTicks(1625),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 29, 20, 29, 11, 152, DateTimeKind.Local).AddTicks(1629),
                            FileName = "Images/TestImage",
                            FileType = "jpg",
                            IsDeleted = false
                        });

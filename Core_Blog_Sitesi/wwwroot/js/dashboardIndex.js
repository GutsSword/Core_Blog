...
$(document).ready(function () {
    ...
    var totalCategoryCountUrl = app.Urls.totalArticleCountUrl;
    ...
    $.ajax({
        ...
        success: function (data) {
            $("h3#totalArticleCount").append(data)   //KRİTİK KISIM appen datayı içine ekler
        },
        error: function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (data) {
            $("h3#totalCategoryCount").append(data)   //KRİTİK KISIM appen datayı içine ekler
        },
        error: function () {
